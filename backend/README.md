...
## Project Structure
    ...
    ├── testapiautosetting_127316  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127316`
...
2. Clone this repo and `cd testapiautosetting_127316`
